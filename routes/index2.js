  ...
  // console.log(result);
       ...
       else
       {
         ...
         // console.log(result[0]);
                                   ...
                                   // await web3.eth.getTransactionCount(result[0], async function(err, counts){
                                   //   if(!err)
                                   //   {
                                       var flag = 0;
                                       ...
                                       {
                                         console.log("i "+i);
                                        var prom = await Courses.methods.getTransaction(i)
                                         .call({from: result[0]},
                                           async function(error, emailTransaction)
                                           {
                                               if(!error)
                                               {
                                                   console.log(i + " " + emailTransaction[1]);
...
try {
  ...
  res.send("Incorrect Private Key");
    ...
    let qwe = await fetch(url)
      ...
      console.log(ipfsJson.encryptedData);
    ...
    var string123 = decryptMessage.split("\n");
console.log("hiii");
        console.log(string123);
    // console.log(JSON.parse(decryptMessage));
    console.log("hiii");
    console.log(string123[0] + "\n" + string123[1]);

    for(var i=0; i < string123.length; i++)
    {
      console.log(i);
      console.log(string123[i]);
    }
